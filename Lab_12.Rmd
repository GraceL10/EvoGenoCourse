...
![](images/gal_cytoscape_image.png)

## Differentially Expressed Genes Tutorial 
![Genes downregulated in ovarian cancer](images/de_genes_down.png)
![](images/de_genes_down_enrichment.png)

![Genes upregulated in ovarian cancer](images/de_genes_up.png)

![](images/de_genes_up_enrichment.png)

![Disease query network](images/disease_query_network.png)
...
```
![](images/node_shapes_network.png)
